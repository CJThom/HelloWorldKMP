...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation(projects.app.pickup.pickupCore.pickupCoreData)

            implementation(projects.app.pickup.pickupFeatures.orders.ordersDomain)
...
android {
    namespace = "com.gpcasiapac.gpchelloworldkmp.app.pickup"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.gpcasiapac.gpchelloworldkmp.app.pickup"
...
compose.desktop {
    application {
        mainClass = "com.gpcasiapac.gpchelloworldkmp.app.pickup.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.gpcasiapac.gpchelloworldkmp.app.pickup"
